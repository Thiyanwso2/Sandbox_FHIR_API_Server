...
public isolated class InternationalOrganizationSourceConnect {
    ...
    *OrganizationSourceConnect;
    ...
    isolated function search(map<r4:RequestSearchParameter[]> params, r4:FHIRContext ctx) returns r4:Bundle|Organization[]|r4:FHIRError {
    ...
    isolated function create(r4:FHIRResourceEntity entity, r4:FHIRContext ctx) returns string|r4:FHIRError {
        ...
        r4:Organization|error requestPayload = entity.unwrap().ensureType(r4:Organization);
