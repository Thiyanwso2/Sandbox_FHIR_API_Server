...
public type Organization r4:Organization;

//add implemented profiles to this map. profileURL:implementation
isolated final map<OrganizationSourceConnect> profileImpl = {
    "http://hl7.org/fhir/StructureDefinition/Organization": new InternationalOrganizationSourceConnect()
};
...
service / on new http:Listener(9090) {
    ...
    isolated resource function get fhir/r4/Organization(http:RequestContext ctx, http:Request request) returns @http:Payload {mediaType: [r4:FHIR_MIME_TYPE_JSON, r4:FHIR_MIME_TYPE_XML]} json|xml|r4:FHIRError {
    ...
    resource function post fhir/r4/Organization(http:RequestContext ctx, http:Request request) returns @http:Payload {mediaType: [r4:FHIR_MIME_TYPE_JSON, r4:FHIR_MIME_TYPE_XML]} json|r4:FHIRError {
