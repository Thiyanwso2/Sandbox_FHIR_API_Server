...
public type Practitioner r4:Practitioner;

//add implemented profiles to this map. profileURL:implementation
isolated final map<PractitionerSourceConnect> profileImpl = {
    "http://hl7.org/fhir/StructureDefinition/Practitioner": new InternationalPractitionerSourceConnect()
};
...
service / on new http:Listener(9090) {
    ...
    isolated resource function get fhir/r4/Practitioner(http:RequestContext ctx, http:Request request) returns @http:Payload {mediaType: [r4:FHIR_MIME_TYPE_JSON, r4:FHIR_MIME_TYPE_XML]} json|xml|r4:FHIRError {
    ...
    resource function get fhir/r4/Practitioner/[string id](http:RequestContext ctx) returns @http:Payload {mediaType: [r4:FHIR_MIME_TYPE_JSON, r4:FHIR_MIME_TYPE_XML]} json|xml|r4:FHIRError {
    ...
    resource function post fhir/r4/Practitioner(http:RequestContext ctx, http:Request request) returns @http:Payload {mediaType: [r4:FHIR_MIME_TYPE_JSON, r4:FHIR_MIME_TYPE_XML]} json|r4:FHIRError {
