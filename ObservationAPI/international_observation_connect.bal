...
public isolated class InternationalObservationSourceConnect {
    ...
    *ObservationSourceConnect;
    ...
    isolated function search(map<r4:RequestSearchParameter[]> params, r4:FHIRContext ctx) returns r4:Bundle|Observation[]|r4:FHIRError {
    ...
    isolated function create(r4:FHIRResourceEntity entity, r4:FHIRContext ctx) returns string|r4:FHIRError {
        ...
        r4:Observation|error requestPayload = entity.unwrap().ensureType(r4:Observation);
